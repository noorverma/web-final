...
const ContactForm = () => {
  ...
  return (
    <div className='flex h-screen align-center bg-navbar justify-center m-auto'>
      <form className='justify-center m-auto border-2 rounded-lg p-10' action={sendMail}>
        <div className='justify-center text-center text-4xl font-bold'> Get in Contact!</div>
        <div className='m-3 mt-10'>
          <label>Full Name:</label>
          <input type='text' id='name' name='fname' value={formData.fname} onChange={handleChange} className='relative border-2 border-black h-6 right-0 ml-2 w-2/3' />
        </div>
        <div className='m-3'>
          <label>Email:</label>
          <input type='email' id='email' name='email' value={formData.email} onChange={handleChange} className='border-2 border-black h-6 ml-11 w-2/3' required />
        </div>
        <div className='m-3'>
          <label>Message:</label>
